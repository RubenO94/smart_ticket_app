...
class EditarAvaliacaoScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EditarAvaliacaoScreen> createState() =>
      _EditarAvaliacaoScreenState();
}

class _EditarAvaliacaoScreenState extends ConsumerState<EditarAvaliacaoScreen> {
  ...
  Future<bool> _onWillPop() async {
    if (_respostas.isNotEmpty && _respostas != widget.aluno.respostas) {
