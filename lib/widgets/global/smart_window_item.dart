...
class SmartWindowItem extends ConsumerStatefulWidget {
  const SmartWindowItem({super.key, required this.janela, required this.tipoPerfil});
  final Janela janela;
  final int tipoPerfil;

  @override
  ConsumerState<SmartWindowItem> createState() => _SmartWindowItemState();
}

class _SmartWindowItemState extends ConsumerState<SmartWindowItem> {
